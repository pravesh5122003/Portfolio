...
const About = () => {
  return (
    ...
    >
     ...
     {/* Resume Button */}
<motion.a
  href="https://drive.google.com/file/d/1T8wENK2axcSTcqW6dC_QtqGoKcpygviz/view?usp=sharing"
  target="_blank"
...
>
  DOWNLOAD CV
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 120 }}   // 👈 start off to the right
          whileInView={{ opacity: 1, x: 0 }} // 👈 slide into place
          transition={{ duration: 1.2, ease: "easeOut" }} // 👈 smooth & slow
          viewport={{ once: true }}
        >
          <Tilt
